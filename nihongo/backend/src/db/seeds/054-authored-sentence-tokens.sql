...
INSERT INTO sentence_tokens (id, sentence_id, index, surface, reading, word_id, char_start, char_end, furigana) VALUES
  ...
  (gen_random_uuid()::text, 'sent-ex-desu-1', 4, 'す', 'す', NULL, 5, 6, '[{"t":"す"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-1', 5, '。', '。', NULL, 6, 7, '[{"t":"。"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-desu-2', 4, 'す', 'す', NULL, 4, 5, '[{"t":"す"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-2', 5, '。', '。', NULL, 5, 6, '[{"t":"。"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-desu-4', 4, 'す', 'す', NULL, 7, 8, '[{"t":"す"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-4', 5, '。', '。', NULL, 8, 9, '[{"t":"。"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-dict-1', 0, '毎日', 'まいにち べんきょう', '7475b67c-3081-49d9-81ce-4065be5e79f2', 0, 2, '[{"t":"毎日","r":"まいにち べんきょう"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-dict-1', 1, '勉強する', 'する', 'b5a69b9b-5017-4a76-b301-dbd5c9f5ba2a', 2, 6, '[{"t":"勉強","r":" "},{"t":"する"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-dict-1', 2, '。', '。', NULL, 6, 7, '[{"t":"。"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-dict-2', 0, '明日', 'あした とも', '823cfb1a-cb34-4c88-86d6-5cdfca69eed5', 0, 2, '[{"t":"明日","r":"あした とも"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-dict-2', 1, '友だち', 'だち', '826a97e0-e8f0-4ae7-a4ce-c9899a7a3c6f', 2, 5, '[{"t":"友だち","r":"だち"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-vclass-3', 0, '毎日', 'まいにち べんきょう', '7475b67c-3081-49d9-81ce-4065be5e79f2', 0, 2, '[{"t":"毎日","r":"まいにち べんきょう"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-vclass-3', 1, '勉強する', 'する', 'b5a69b9b-5017-4a76-b301-dbd5c9f5ba2a', 2, 6, '[{"t":"勉強","r":" "},{"t":"する"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-masu-1', 0, '毎日', 'まいにち べんきょう', '7475b67c-3081-49d9-81ce-4065be5e79f2', 0, 2, '[{"t":"毎日","r":"まいにち べんきょう"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-masu-1', 1, '勉強します', 'します', 'b5a69b9b-5017-4a76-b301-dbd5c9f5ba2a', 2, 7, '[{"t":"勉強","r":" "},{"t":"します"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-masu-1', 2, '。', '。', NULL, 7, 8, '[{"t":"。"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-masu-3', 0, '明日', 'あした かいしゃ', '823cfb1a-cb34-4c88-86d6-5cdfca69eed5', 0, 2, '[{"t":"明日","r":"あした かいしゃ"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-masu-3', 1, '会社', NULL, '25dda620-f5a1-476f-8bb1-bef2843c78ea', 2, 4, '[{"t":"会社"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-te-4', 0, '電話して', 'でんわ して', 'd39abe7d-c638-4789-b2c7-368c66d1feec', 0, 4, '[{"t":"電話","r":"でんわ "},{"t":"して"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-ta-1', 0, '昨日', 'きのう えいが', '89b5855e-63be-4984-8c64-31de7d611fca', 0, 2, '[{"t":"昨日","r":"きのう えいが"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-ta-1', 1, '映画', NULL, '94093c2a-fa1e-4b90-9f87-b13ba46cd7fb', 2, 4, '[{"t":"映画"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-teiru-4', 2, '結婚して', 'けっこん して', '0454357b-7542-44a9-b003-c9e3ecdaef90', 2, 6, '[{"t":"結婚","r":" けっこん "},{"t":"して"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-nai-3', 1, 'も', 'も', NULL, 1, 2, '[{"t":"も"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-nai-3', 2, '食べない', 'たべない', '788557df-2bac-4ae7-a157-8a81fbe1da16', 2, 6, '[{"t":"食","r":" た"},{"t":"べない"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-nai-3', 3, '。', '。', NULL, 6, 7, '[{"t":"。"}]'::jsonb),
  ...
  (gen_random_uuid()::text, 'sent-ex-desu-3', 0, '母', 'は', '85939c87-5d17-44b2-affc-26fb46091623', 0, 1, '[{"t":"母","r":"は"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-3', 1, 'は', 'は', '0dacf911-48fa-4c5e-8d6f-d2b5cd33a0b6', 1, 2, '[{"t":"は"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-3', 2, '先生', 'わ せんせい', 'f2bd1cf4-e22c-48f8-a563-771e2f0599a9', 2, 4, '[{"t":"先生","r":" わ せんせい"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-3', 3, 'で', 'で', '107c2108-67cd-4a47-b42b-0e4f19b2a745', 4, 5, '[{"t":"で"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-3', 4, 'す', 'す', NULL, 5, 6, '[{"t":"す"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-desu-3', 5, '。', '。', NULL, 6, 7, '[{"t":"。"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-vclass-1', 0, '毎朝', 'まいあさ はや', '8c5d3deb-3d5e-4808-9058-cb502a0aa843', 0, 2, '[{"t":"毎朝","r":"まいあさ はや"}]'::jsonb),
  (gen_random_uuid()::text, 'sent-ex-vclass-1', 1, '早く', 'く', '416d3a31-5940-475c-8c7f-d7997aff8665', 2, 4, '[{"t":"早く","r":"く"}]'::jsonb),
