-- Rebuild the embedded dialogue prompts, again.
--
-- 033 rewrote every explanation and the snapshots in `exercise_prompts` still
-- held the old ones. Any edit to a dialogue table needs this to follow it.
-- Identical to 032; kept as a separate file because seeds run exactly once.
--
