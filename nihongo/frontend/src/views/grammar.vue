      ...
      <div v-if="!loading" class="mt-6 flex flex-wrap items-center gap-3">
        <div class="relative">
          ...
          <input
            ...
            class="w-56 rounded-lg border border-[var(--color-border)] bg-transparent py-2 pl-9 pr-3 text-base sm:text-sm outline-none transition focus:border-[var(--color-text)]"
            autocomplete="off"
            autocapitalize="off"
            spellcheck="false"
          >
